...
INDEX_TYPE = {
    "flags": ["-x", "--index_type"],
    "keys": {"help": "Type of index to fetch.", "default": "taxon", "type": str},
}

INPUT_PATH = {
    "flags": ["-i", "--input_path"],
    "keys": {"help": "Path to the input file.", "required": True, "type": str},
}
...
OUTPUT_PATH = {
    "flags": ["-o", "--output_path"],
    "keys": {"help": "Path to the output file.", "required": True, "type": str},
}
...
S3_PATH_OPTIONAL = {**S3_PATH, "keys": {**S3_PATH["keys"], "required": False}}
...
YAML_PATH = {
    "flags": ["-y", "--yaml_path"],
    "keys": {"help": "Path to the source YAML file.", "required": True, "type": str},
}
